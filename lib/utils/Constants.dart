...
const TextTheme TEXT_THEME = TextTheme(
  headline1: TextStyle(
      color: COLOR_BLACK, fontWeight: FontWeight.bold, fontSize: 48, fontFamily: 'SairaCondensed'
  ),
  headline2: TextStyle(
      color: COLOR_BLACK, fontWeight: FontWeight.normal, fontSize: 24, fontFamily: 'SairaCondensed'
  ),
  headline3: TextStyle(
      color: COLOR_DARK_BLUE, fontWeight: FontWeight.normal, fontSize: 18, fontFamily: 'SairaCondensed'
  ),
);
      ...
      child:Scaffold(
        body: Container(
          ...
          child: Column(
            children: [
              Padding(
                padding: EdgeInsets.symmetric(horizontal: SizeConfig.blockSizeHorizontal*6.3, vertical: SizeConfig.blockSizeVertical*3.5),
                child: Row (
              ...
              Padding(
                padding: EdgeInsets.only(top: SizeConfig.blockSizeVertical*2.53),
                child: Container(
              ...
              Padding(
                padding: EdgeInsets.only(top: SizeConfig.blockSizeVertical*3.52),
                child:  PanelButton(
              ...
              Padding(
                  padding: EdgeInsets.only(top: SizeConfig.blockSizeVertical*2.4),
                  child:  PanelButton(
                      width: SizeConfig.blockSizeHorizontal*90.5,
